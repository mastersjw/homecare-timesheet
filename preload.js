...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openSupervisor: () => ipcRenderer.invoke('open-supervisor'),
  closeSupervisor: () => ipcRenderer.invoke('close-supervisor'),
  focusSupervisor: () => ipcRenderer.invoke('focus-supervisor'),
